...
rb_manager.geometry("1100x400+300+300")
...
bt_save_dtlane = tkinter.Button(f1_func_window, text="save dtlane", command=save_dtlane)
bt_emergency_next = tkinter.Button(f1_func_window, text="emergency unblocking", command=force_unblock)

bt_check_linestring.grid(row=0, column=0)
bt_check_point_csv.grid(row=1, column=0)
bt_check_rosbag.grid(row=2, column=0)
bt_check_current_lanes.grid(row=0, column=1)
bt_check_current_paths.grid(row=1, column=1)
bt_open_linestring.grid(row=0, column=2)
bt_open_point_csv.grid(row=1, column=2)
bt_open_rosbag.grid(row=2, column=2)
bt_drag_lanes.grid(row=0, column=3)
bt_drag_each_lanes.grid(row=1, column=3)
bt_pick_each_point.grid(row=2, column=3)
bt_drop_lanes.grid(row=3, column=3)
bt_reverse_lanes.grid(row=4, column=3)
bt_connect_lanes.grid(row=5, column=3)
bt_save_dtlane.grid(row=6, column=4)
bt_emergency_next.grid(row=3, column=0)
